export default function AOTMEcosystem() {
    return (
        <section className="bg-[#101010] py-32 px-4 relative overflow-hidden">
            <div className="absolute top-0 -left-[20%] w-[800px] h-[800px] bg-[var(--color-primary-400)]/10 blur-[120px] rounded-full pointer-events-none opacity-50" />
            <div className="absolute bottom-0 -right-[20%] w-[800px] h-[800px] bg-[var(--color-primary-400)]/10 blur-[120px] rounded-full pointer-events-none opacity-50" />
            <div className="max-w-4xl mx-auto">
                ...
                <div className="relative space-y-12">
                    <div className="absolute left-[2.5rem] md:left-1/2 top-10 bottom-10 w-px border-l-2 border-dashed border-white/10 -translate-x-1/2 hidden md:block" />
                    
                    <div className="absolute left-8 top-10 bottom-10 w-px border-l-2 border-dashed border-white/10 -translate-x-1/2 md:hidden" />
        ...
        <div className="relative group cursor-pointer">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16">
                ...
                <div className="flex-1 bg-[#101010] p-8 md:p-10 rounded-3xl border border-white/10 shadow-sm hover:border-[var(--color-primary-400)]/40 hover:shadow-lg hover:shadow-[var(--color-primary-400)]/5 transition-all duration-300 ease-out w-full transform md:group-hover:translate-x-2">
                    ...
                    <p className="text-zinc-400 leading-relaxed text-lg font-sansation">
                        {description}
                    </p>
                </div>
            </div>
